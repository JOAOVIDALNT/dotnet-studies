...
{
    Console.WriteLine($"Id: {sell.Id}, Product: {sell.Name}, Price: {sell.Price}, Sell Date: {sell.SellDate.ToString("dd/MM/yyyy HH:mm")}, {(sell.Discount.HasValue ? $"Discount: {sell.Discount}" : "")}");
}